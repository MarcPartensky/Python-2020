...
waiting = True
while waiting:
    elements = driver.find_elements_by_xpath("//div[text()='Waiting for competitors...']")
...
waiting = True
while waiting:
    countdowns = driver.find_elements_by_css_selector("body > div.countdownPopup.horizontalCountdownPopup > div > table > tbody > tr > td > table > tbody > tr > td:nth-child(1)")
    waiting = bool(countdowns)

time.sleep(1)
textspans = driver.find_element_by_xpath('//*[@id="gwt-uid-17"]/table/tbody/tr[2]/td/table/tbody/tr[1]/td/table/tbody/tr[1]/td/div/div')
